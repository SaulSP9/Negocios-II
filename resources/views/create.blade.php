...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Helvetica Neue', Arial, sans-serif; }
        ...
        .btn-submit { width: 100%; background: #000; color: #fff; border: none; padding: 14px; font-weight: 900; text-transform: uppercase; letter-spacing: 1px; cursor: pointer; margin-top: 10px; transition: background 0.2s; }
        ...
        .alert-error { background: #ff0033; color: #fff; padding: 10px; font-size: 12px; font-weight: bold; margin-bottom: 20px; }
    </style>
</head>
<body>
